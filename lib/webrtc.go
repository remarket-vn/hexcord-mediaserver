...
func CreateWebRTCConnection(ingestionAddress, streamKey, offerStr string) (answerOutput string, err error) {
	...
	answerOutput := signal.Encode(*peerConnection.LocalDescription())
